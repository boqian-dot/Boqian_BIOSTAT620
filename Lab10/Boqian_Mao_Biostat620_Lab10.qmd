---
title: "Boqian_Mao_Biostat_620_Lab10"
author: "Boqian Mao"
format: html
editor: visual
...
cv_states_today_filter <- cv_states_today |> filter(state!="California")
...
### FINISH CODE HERE
MULT_FACTOR <- 50  ### HINT: select mult factor to be approximately 1 / CFR (and also a round number) to get cases and deaths on the same scale.
